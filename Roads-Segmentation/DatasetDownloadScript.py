...
download_folder = "E:\\Datasets\\SateliteToMaps\\dataset\\Training\\Input"
...
class downloader:
    ...
    def __init__(self):
        ...
        self.url = "https://www.cs.toronto.edu/~vmnih/data/mass_roads/train/sat/index.html"
    ...
    def loadBrowser(self):
        ...
        try:
            ...
            self.browser = webdriver.Chrome(chrome_options=self.settings, executable_path=r"E:\chromedriver.exe")
